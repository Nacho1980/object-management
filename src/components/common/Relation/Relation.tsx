...
import { IconSpan, MarginSpan, StyledField } from "./styles";
/**
...
export const Relation = ({ dataTestId, name, obj1Id, obj2Id }: IRelation) => {
  ...
  return (
    <>
      ...
      <StyledField>
        <IconSpan data-testid={`${dataTestId}-obj1Icon`}>
          {obj1TypeIcon}
        </IconSpan>
        <MarginSpan data-testid={`${dataTestId}-obj1Name`}>
          {obj1?.name}
        </MarginSpan>
      </StyledField>
      <StyledField>
        <IconSpan data-testid={`${dataTestId}-obj2Icon`}>
          {obj2TypeIcon}
        </IconSpan>
        <MarginSpan data-testid={`${dataTestId}-obj2Name`}>
          {obj2?.name}
        </MarginSpan>
      </StyledField>
    </>
